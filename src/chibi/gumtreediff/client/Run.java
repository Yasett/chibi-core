...
import chibi.gumtreediff.gen.Registry;
import chibi.gumtreediff.gen.TreeGenerator;
...
//    }
    ...
    public static void initGenerators() {
        Reflections reflections = new Reflections("chibi.gumtreediff.gen");

        reflections.getSubTypesOf(TreeGenerator.class).forEach(
                gen -> {
                    chibi.gumtreediff.gen.Register a =
                            gen.getAnnotation(chibi.gumtreediff.gen.Register.class);
                    if (a != null)
    ...
    public static void initClients() {
        Reflections reflections = new Reflections("chibi.gumtreediff.client");

        reflections.getSubTypesOf(Client.class).forEach(
                cli -> {
                    chibi.gumtreediff.client.Register a =
                            cli.getAnnotation(chibi.gumtreediff.client.Register.class);
                if (a != null)
