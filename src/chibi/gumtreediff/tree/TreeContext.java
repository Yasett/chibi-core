...
import chibi.gumtreediff.tree.AbstractTree;
...
import chibi.gumtreediff.io.TreeIoUtils.MetadataSerializer;
import chibi.gumtreediff.io.TreeIoUtils.MetadataUnserializer;
import chibi.gumtreediff.io.TreeIoUtils.TreeFormatter;
...
public class TreeContext {
    ...
    public ITree createTreeMethodInvocation(int type, String label, String typeLabel, String methodName, List arguments) {
        registerTypeLabel(type, typeLabel);
        
        return new TreeMethodInvocation(type, label, methodName);
    }
